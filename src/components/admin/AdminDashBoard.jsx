...
const AdminDashBoard = () => {
  return (
    <section className='mx-1 md:py-4 md:mx-48 lg:mx-64 md:text-xl mt-28'>
      <div className='border bg-[#ff2424e3] text-white text-center py-2  '>
      ...
      <ul className='flex flex-col  border text-center text-[brown] text-lg'>
        ...
        <Link className='border-b-2 py-3 md:py-5 hover:bg-indigo-100' to="/admin/plot">Land Plots</Link>
        ...
        <Link className='border-b-2 py-3 md:py-5 hover:bg-indigo-100' to="/admin/exporter">Exporters</Link>
